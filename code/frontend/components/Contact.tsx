...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (Object.keys(errs).length > 0) {
      ...
      if (errs.name) firstErrorRef.current?.focus()
      return
    }
    ...
    const href = `mailto:hello@example.com?subject=${subject}&body=${body}`
            ...
            >
              ...
              <div className={`field${errors.name ? ' invalid' : ''}`}>
                ...
                <input
                  ...
                  required
                  autoComplete="name"
                  ref={errors.name && !firstErrorRef.current ? firstErrorRef : undefined}
                />
                {errors.name && (
              ...
              {submitted && (
                <div className="form-success" role="status">
                  ✅ Your email app should have opened. If not, email me directly
                  at{' '}
                  <a href="mailto:hello@example.com" style={{ textDecoration: 'underline' }}>
                    hello@example.com
                  </a>
                  .
                </div>
          ...
          <div className="contact-info reveal">
            ...
            <div className="contact-card">
              ...
              <div className="social-links">
                ...
                <a href="#" className="social-link" aria-label="Twitter / X profile">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
